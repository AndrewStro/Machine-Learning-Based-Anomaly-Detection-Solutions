...
TestingData='Testing-a1-a3.csv'
print(TrainingData +", "+ TestingData)
# Batch Size
BatchSize=10
# Epohe Size
NumEpoch=10
...
X_train, y_train = dp.get_processed_data(TrainingData, './Mappings/', classType='binary')
X_test, y_test = dp.get_processed_data(TestingData, './Mappings/', classType='binary')
